...
public class CodeGenerator {
    ...
    public void main1() {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/schedule?serverTimezone=GMT%2B8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("2386313490");
        dsc.setDbType(DbType.MYSQL);
        mpg.setDataSource(dsc);
        // 4、包配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName("service_schedule"); //模块名
        pc.setParent("com.schedule");
